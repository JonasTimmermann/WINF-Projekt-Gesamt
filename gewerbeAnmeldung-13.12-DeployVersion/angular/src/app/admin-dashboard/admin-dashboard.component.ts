...
resetQuestion(): void{
  ...
  this.choices = {id: 0, choice: "", nextQuestionId: null, questionType: null};
  this.chArray = [this.choices];
  this.questionType = {id: 0, type: "", nextQuestionId: null, choices: this.chArray };
  this.questionCategory = {id: 0, category: "", processNumber: 1}; 
  this.qcArray = [this.questionCategory];


  this.question = {id: 2, question: "Frage eingeben", questionType: this.questionType, hint: "", formType: "", questionCategory: this.qcArray};
  this.toggleEdit();
}
