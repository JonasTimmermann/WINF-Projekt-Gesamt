...
export class AntragtextService {
  ...
  changeShownText(text: string){
    ...
    // TODO Änder
    this.shownText.emit(this.text); 
    this.showText = true; 
  }
  text: string = `<h3 class="text-center"> Antrag auf Sondernutzungs einer öffentlichen Grünfläche. </h3>
  <p class="lead"> Die Nutzung der öffentlichen Grünflächen der Landeshauptstadt Kiel wird
      durch die <a href="/">"Satzung zum Schutz der öffentlichen Grünanlagen vom 09.04.1984"</a>
      ...
      die Grünflächenamt für heimisch Tier- und Pflanzenarten, die es zu schützen gilt.
  ...
  <p class="lead"> Um eine unnötige Verzögerung der Bearbeitung zu vermeiden, empfehlen wir, das
      ...
      Über eine etwaige Gebührenbefreiung informieren Sie sich bitte hier: <a href="/">Verwaltungsgebührensatzung</a>, PDF.
